...
struct PatientDetailScene {
    static func makeView(patient: PatientRecord, dependencies: AppDependencies, coordinator: AppCoordinator) -> some View {
        ...
        return PatientDetailView(viewModel: viewModel, dependencies: dependencies, coordinator: coordinator)
    }
}
